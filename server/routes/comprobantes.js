...
let firma = async(clave, res, claveFirma, pathCertificado, ambiente) => {
    ...
    await reader.addEventListener('loadend', function(e) {
        ...
        let xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
            ...
            "      <xml>" + Buffer(comprobanteFirmado, 'utf8').toString('base64') + "</xml>" +
...
let guardarFactura = async(body, usuario, res) => {
    ...
    let respuesta = await firma(claveAcceso, res, empresaDB.claveFirma, empresaDB.pathCertificado, empresaDB.ambiente);
